...
const steps = [
  {
    icon: Search,
    title: "Product discovered in India",
    desc: "Find what you love on any Indian e-commerce store.",
  },
  {
    icon: LinkIcon,
    title: "Product link submitted",
    desc: "Paste the URL in your PickoPick dashboard.",
  },
  {
    icon: ShoppingBag,
    title: "PickoPick purchases",
    desc: "We buy the item on your behalf locally.",
  },
  {
    icon: Warehouse,
    title: "Package arrives at warehouse",
    desc: "We receive, inspect, and store your items.",
  },
  {
    icon: PlaneTakeoff,
    title: "International shipping",
    desc: "Choose your preferred global courier.",
  },
  {
    icon: Globe2,
    title: "Package travels globally",
    desc: "Real-time tracking across borders.",
  },
  {
    icon: PackageCheck,
    title: "Package delivered",
    desc: "Safe arrival at your doorstep worldwide.",
  },
];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-24">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-blue-100 bg-blue-50 text-xs font-bold uppercase tracking-widest text-[#0B56D9] mb-4">
            How It Works
          </div>
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-[#0A1931]">
        ...
        <div className="relative hidden md:block max-w-4xl mx-auto">
          ...
          <div className="absolute left-1/2 top-8 bottom-8 -translate-x-1/2 w-0.5 bg-slate-200" />

          {/* Animated path progress */}
          <motion.div
            className="absolute left-1/2 top-8 -translate-x-1/2 w-0.5 bg-gradient-to-b from-[#0B56D9] to-[#FF6321]"
            style={{ height: packageY }}
          />
                ...
                >
                  ...
                  >
                    <div className="mx-auto max-w-md rounded-2xl border border-slate-200/80 bg-white p-6 sm:p-7 text-left hover:border-[#0B56D9]/40 transition-colors group">
                      <h3 className="text-lg font-extrabold tracking-tight text-[#0A1931] transition-colors group-hover:text-[#0B56D9]">
                        {step.title}
                      </h3>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="flex-1 rounded-2xl border border-slate-200/80 bg-white p-4">
                  <h3 className="text-sm font-extrabold tracking-tight text-[#0A1931]">
                    {step.title}
                  </h3>
