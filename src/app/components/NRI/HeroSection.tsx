...
import { ArrowRight, CalendarCheck2, CheckCircle2, Plane, ShieldCheck } from 'lucide-react';
  ...
  >
    <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-8">
      ...
      <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
        ...
        <button onClick={onStartBooking} className="inline-flex items-center justify-center gap-2 rounded-full border border-white bg-[#0B56D9] px-6 py-3.5 text-xs font-extrabold tracking-wider text-white transition-colors hover:bg-[#0849B7]"><span>SCHEDULE YOUR PICKUP</span><CalendarCheck2 className="h-4 w-4" /></button>
      </div>
