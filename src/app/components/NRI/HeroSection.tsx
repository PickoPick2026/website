  ...
  >
    <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-8">
      ...
      <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
        <button onClick={onOpenConsultation} className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-xs font-extrabold tracking-wider text-[#0B56D9] transition-colors hover:bg-blue-50"><span>SPEAK WITH A CONCIERGE</span><ArrowRight className="h-4 w-4" /></button>
