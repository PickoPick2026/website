    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-8">
      ...
      <div className="mt-12 grid items-center gap-8 lg:grid-cols-[1fr_0.9fr] lg:gap-16">
        <div className="order-2 lg:order-1">
          ...
          <button onClick={onOpenConsultation} className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#0B56D9] px-6 py-3.5 text-xs font-extrabold tracking-wide text-white hover:bg-[#0849B7]">PLAN WITH AN INDIA EXPERT <ArrowRight className="h-4 w-4" /></button>
        </div>
        <div className="order-1 overflow-hidden rounded-3xl border border-blue-100 bg-white lg:order-2"><img src="/images/nri-consultation-concierge-v1.webp" loading="lazy" alt="Pick O Pick NRI concierge consultation with an international shipping specialist" className="aspect-[4/5] h-full w-full object-cover" /></div>
      </div>
    </div>
  </section>
);
